...
export class FuncionariosSuspensosComponent implements OnInit{
    items: IFuncionario[] = [];
  ...
  constructor(
    ...
    this.router.events
      ...
      .subscribe((event: NavigationEnd) => {
        if (event.url === '/funcionarios-suspensos') {
  ...
  loadFuncionarios(): void {
    this.funcionariosAtivosService.getFuncionariosSuspensos().subscribe({
      next: (data) => {
